...
SRCS_RESPONSES	:= responses Response.cpp GetResponse.cpp ErrorResponse.cpp CGIResponse.cpp DirectoryResponse.cpp PostResponse.cpp DeleteResponse.cpp
...
SRC_GROUPS		:= SRCS_ENGINE SRCS_SERVER SRCS_SOCKET SRCS_PARSER SRCS_UTILS \
				   SRCS_RESPONSES SRCS_REQUESTS SRCS_LOGGER
