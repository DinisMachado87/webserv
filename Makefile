...
SRCS_RESPONSES  := responses Response.cpp GetResponse.cpp CGIResponse.cpp
...
SRC_GROUPS		:= SRCS_ENGINE SRCS_SERVER SRCS_RESPONSES SRCS_REQUEST SRCS_SOCKET SRCS_PARSER SRCS_UTILS
